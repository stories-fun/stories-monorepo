    ...
    <div className="min-h-screen bg-[#141414] flex flex-col items-center">
      <div className="w-full max-w-[1400px]">
        ...
        <div className="flex items-center justify-between mb-6 mt-6 px-4">
          ...
          <button
            className="sm:hidden text-[#FFF6C9] text-sm font-bold"
        ...
        {/* Cards Grid */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 mt-[40px] mb-16 sm:mb-[200px] px-4 max-w-[1400px]">
          {stories.map((story, index) => (
            <div
              key={index}
              className={`flex flex-col ${
                !showAll && index > 1 ? "hidden sm:flex" : ""
              }`}
            >
              <MiniCard {...story} />
            </div>
